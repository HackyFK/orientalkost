...
<body class="min-h-screen flex items-center justify-center bg-login relative py-8">
    ...
    <div class="relative z-10 w-full max-w-3xl mx-4 bg-white rounded-3xl shadow-2xl overflow-hidden flex">
        ...
        <div class="hidden md:flex w-5/12 flex-shrink-0 relative flex-col">
            <img src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800" alt="Kos Interior"
        ...
        <div class="flex-1 flex flex-col justify-center px-10 py-10">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3.5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select id="tipe_identitas" name="tipe_identitas"
                            ...
                            <option value="paspor" {{ old('tipe_identitas') == 'paspor' ? 'selected' : '' }}>Paspor
                            </option>
                        </select>
                    </div>

                    <x-input-error :messages="$errors->get('tipe_identitas')" class="mt-1.5" />
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label for="nomor_identitas"
                            class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">NIK</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                <i class="fa-solid fa-id-card text-slate-400 text-xs"></i>
                            </div>
                            <input id="nomor_identitas" name="nomor_identitas" type="text"
                                value="{{ old('nomor_identitas') }}" placeholder="16 digit NIK"
                                class="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-700 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition">
                        </div>
                    ...
                    <div>
                        <label for="phone"
                            class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">No.
                            HP</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div>
                    <label for="alamat"
                        class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Alamat</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label for="password_confirmation"
                            class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">Konfirmasi</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                <i class="fa-solid fa-lock text-slate-400 text-xs"></i>
                            </div>

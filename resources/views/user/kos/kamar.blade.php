                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="harga"
                                        ...
                                        <option value="1" {{ request('harga') == 1 ? 'selected' : '' }}>
                                            < 1 juta </option>

                                        <option value="2" {{ request('harga') == 2 ? 'selected' : '' }}>
                                            1 - 2 juta
                                        </option>

                                        <option value="3" {{ request('harga') == 3 ? 'selected' : '' }}>
                                            2 - 3 juta
                                        </option>

                                        <option value="4" {{ request('harga') == 4 ? 'selected' : '' }}>
                                            > 3 juta
                                        </option>
                        ...
                        <div
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    {{-- Ukuran kamar --}}
                                    <span
                                        class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-semibold flex items-center">
                                    ...
                                    @foreach ($kamar->fasilitas->take(5) as $fasilitas)
                                        <span
                                            ...
                                            <i
                                                class="{{ $fasilitas->icon ?? 'fas fa-circle-check' }} text-accent mr-1"></i>
            ...
            <div class="flex justify-center items-center space-x-2 mt-12 mb-10">
                ...
                @foreach ($kamars->getUrlRange(1, $kamars->lastPage()) as $page => $url)
                    @if ($page == $kamars->currentPage())
                        <span
                            class="w-10 h-10 rounded-lg bg-accent text-white font-semibold flex items-center justify-center">
                            {{ $page }}
                        </span>
                    @else
                        <a href="{{ $url }}"

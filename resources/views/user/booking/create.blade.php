                        ...
                        <div class="px-6 py-5 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    ...
                                    @endif
                                    <label class="radio-card"
                                        :class="jenisSewa === 'bulanan' ? 'border-indigo-400 bg-indigo-50 text-indigo-700' : ''">
                                        <input type="radio" name="jenis_sewa" value="bulanan" x-model="jenisSewa"
                                            class="hidden">
                                        <i class="fa-regular fa-calendar text-xs"></i> Bulanan
                                    </label>
                                    <label class="radio-card"
                                        :class="jenisSewa === 'tahunan' ? 'border-indigo-400 bg-indigo-50 text-indigo-700' : ''">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input id="inputMulai" :type="jenisSewa === 'harian' ? 'text' : 'month'"
                                        :name="jenisSewa === 'harian' ? 'tanggal_mulai' : 'bulan_mulai'" class="input"
                        ...
                        <div class="px-6 py-5 space-y-3 text-sm">
                            ...
                            <template x-if="selectedLayanan.length > 0">
                                <div class="pt-2 border-t border-dashed border-slate-100 space-y-1.5">
                                    <p class="text-xs font-semibold text-slate-400 uppercase tracking-wide">Layanan Dipilih
                                    </p>

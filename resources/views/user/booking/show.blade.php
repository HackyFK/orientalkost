        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-7">
                <div class="flex items-center gap-2 text-xs text-slate-400">
                    <a href="{{ route('user.booking.history') }}" class="hover:text-blue-500 transition-colors">Booking
                        Saya</a>
                ...
                <span
                    ...
                    @if ($booking->status === 'pending')
                        <a href="{{ route('user.payment.show', $booking->id) }}"
                            class="inline-flex items-center gap-1 px-2 py-1 text-orange-600 rounded-md text-xs font-semibold
          hover:bg-orange-100 hover:text-orange-700 transition duration-200 ease-in-out">
                    ...
                    @else
                        <span class="inline-flex items-center gap-1 text-xs font-semibold">
                            ...
                            {{ $label[$booking->status] ?? ucfirst($booking->status) }}
                        </span>
                    @endif
                </span>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
                            <div class="w-8 h-8 rounded-xl bg-blue-50 flex items-center justify-center">
                                <i class="fa-solid fa-door-open text-blue-400 text-xs"></i>
                            </div>
                        ...
                        @else
                            <div class="px-6 py-12 flex flex-col items-center gap-3 text-center">
                                <div class="w-14 h-14 rounded-full bg-slate-100 flex items-center justify-center">
                                    <i class="fa-solid fa-credit-card text-slate-300 text-xl"></i>
                                </div>
                ...
                <div class="space-y-5">
                    ...
                    {{-- ── Total Bayar ── --}}
                    <div class="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-6 shadow-md">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div class="px-5 py-4 border-b border-slate-100 flex items-center gap-3">
                            <div class="w-8 h-8 rounded-xl bg-amber-50 flex items-center justify-center">
                                <i class="fa-solid fa-circle-dot text-amber-400 text-xs"></i>
                            </div>
                        ...
                        <div class="px-5 py-5 space-y-4">
                            ...
                            <div
                                ...
                                <i class="fa-solid {{ $statusStyle['icon'] }} text-lg"></i>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        ...
                        <div class="divide-y divide-slate-50">
                            <div class="px-5 py-3.5 flex items-center justify-between">
                                <span class="text-xs text-slate-400">ID Booking</span>
                                <span
                            ...
                            <div class="px-5 py-3.5 flex items-center justify-between">
                                <span class="text-xs text-slate-400">Terakhir Diperbarui</span>
                                <span

            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-10 lg:col-start-2 xl:col-span-8 xl:col-start-3">
                    ...
                    <div class="bg-white rounded-3xl shadow-lg p-8 lg:p-10">
                        <div class="mb-10 text-center">
                            ...
                            <p class="text-textGray max-w-xl mx-auto">
                                Lengkapi informasi booking Anda untuk melanjutkan ke proses pembayaran dengan aman
                            </p>
                        </div>
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" required placeholder="Masukkan nama lengkap"
                                            class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl font-medium text-primary
                       focus:outline-none focus:border-accent focus:ring-4 focus:ring-orange-100">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" required placeholder="KTP / KARTU PELAJAR"
                                            class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl font-medium text-primary
                       focus:outline-none focus:border-accent focus:ring-4 focus:ring-orange-100">
                                    </div>
                       ...
                       focus:outline-none focus:border-accent focus:ring-4 focus:ring-orange-100">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" required placeholder="08xxxxxxxxxx"
                                            class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl font-medium text-primary
                       focus:outline-none focus:border-accent focus:ring-4 focus:ring-orange-100">
                                    </div>
                                </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <textarea rows="3" required placeholder="Masukkan alamat sesuai identitas"
                                        class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl font-medium text-primary
                   focus:outline-none focus:border-accent focus:ring-4 focus:ring-orange-100 resize-none"></textarea>
                            ...
                            <!-- Info Box -->
                            <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-5 text-sm text-blue-900">
                                <div class="flex gap-3">
                                    <i class="fas fa-info-circle text-blue-500 text-lg mt-0.5"></i>
                                    <div>
                                        <strong class="block mb-2">Informasi Penting:</strong>
                                        <ul class="space-y-1 list-disc list-inside">
                                            <li>Harap Masukan data dengan benar dan teliti</li>
                                            <li>Setelah booking wajib lakukan transaksi</li>
                                            <li>Harap tunggu admin mengkonfirmasi data dan dikirim lewat email</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 mt-10">
                                ...
                                <a href="{{ route('user.booking') }}"
                                    class="flex-1 flex items-center justify-center gap-2 border-2 border-gray-300 text-secondary
               py-4 rounded-xl font-semibold transition
               hover:border-accent hover:text-accent hover:bg-orange-50">
                                    <i class="fas fa-arrow-left"></i>
                                    Kembali
                                </a>

                               
                                <form action="{{ route('user.transaksi') }}" method="GET">
                                    <!-- Tombol Lanjut -->
                                    <button type="submit"
                                        class="flex-1 flex items-center justify-center gap-2 gradient-orange text-white

...
@section('content')
    <h1 class="text-xl font-bold mb-6">Tambah Kamar</h1>
    ...
    <form action="{{ route('admin.kamar.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nama_kamar" class="w-full border p-2">
        </div>

        <div>
            <label>Tipe Kamar</label>
            <input type="text" name="tipe_kamar" class="w-full border p-2">
        </div>

        <div class="grid grid-cols-2 gap-4">
            <div>
                <label>Lantai</label>
                <input type="number" name="lantai" class="w-full border p-2">
            </div>
            <div>
                <label>Nomor Kamar</label>
                <input type="text" name="nomor_kamar" class="w-full border p-2">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="harga_bulanan" class="w-full border p-2">
            </div>
            <div>
                <label>Harga Tahunan</label>
                <input type="number" name="harga_tahunan" class="w-full border p-2">
            </div>
        </div>

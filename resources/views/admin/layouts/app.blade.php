...
<body class="bg-slate-100 text-gray-800">
        ...
        <aside id="sidebar" class="relative w-64 flex flex-col bg-[#0f172a] border-r border-blue-900/30 shadow-xl">
            ...
            <div class="flex items-center gap-3 px-5 py-[18px] border-b border-blue-900/40">
                ...
                <div class="leading-tight">
                    ...
                    <p class="text-slate-500 text-[10px] font-semibold uppercase tracking-widest">
            ...
            <nav id="sidebar-nav" class="flex-1 px-3 py-3 overflow-y-auto space-y-0.5">
                ...
                <div x-data="{ open: {{ $isActive('admin.keuangan.*') ? 'true' : 'false' }} }" class="relative">
    ...
    <button @click="open = !open"
        ...
        <span class="flex items-center gap-3">
            <i class="fa-solid fa-file-lines text-center w-4 text-xs {{ $isActive('admin.keuangan.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
            Laporan
        </span>
    ...
    <div x-show="open" x-transition class="mt-1 pl-6 flex flex-col gap-1">
        ...
        <a href="{{ route('admin.keuangan.index') }}"
           ...
           {{ $isActive('admin.keuangan.index') ? 'nav-active bg-blue-500/10 text-slate-100' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}">
            <i class="fa-solid fa-money-bill text-center w-4 text-xs {{ $isActive('admin.keuangan.index') ? 'text-blue-400' : 'text-slate-500' }}"></i>
            Keuangan
        </a>
        ...
        <a href="{{ route('admin.keuangan.laporan') }}"
           ...
           {{ $isActive('admin.keuangan.laporan') ? 'nav-active bg-blue-500/10 text-slate-100' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}">
            <i class="fa-solid fa-house text-center w-4 text-xs {{ $isActive('admin.keuangan.laporan') ? 'text-blue-400' : 'text-slate-500' }}"></i>
            Kos & Kamar
        </a>

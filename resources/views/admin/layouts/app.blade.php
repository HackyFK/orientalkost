...
<head>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        #sidebar-nav::-webkit-scrollbar-thumb { background: rgba(59,130,246,0.18); border-radius: 4px; }
    </style>
</head>
...
<div class="flex min-h-screen">
    ...
    <aside id="sidebar" class="relative w-64 flex flex-col bg-[#0f172a] border-r border-blue-900/30 shadow-xl">
        ...
        <div class="flex items-center gap-3 px-5 py-[18px] border-b border-blue-900/40">
            <div class="flex-shrink-0 w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-600/40">
        ...
        <nav id="sidebar-nav" class="flex-1 px-3 py-3 overflow-y-auto space-y-0.5">
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-chart-pie w-4 text-center text-xs {{ $isActive('admin.dashboard') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Dashboard
            </a>

            {{-- ── Manajemen ── --}}
            <p class="px-3 pt-4 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-500/70">Manajemen</p>
            ...
            <a href="{{ route('admin.kos.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-house w-4 text-center text-xs {{ $isActive('admin.kos.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Kos
            </a>
            ...
            <a href="{{ route('admin.kamar.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-door-open w-4 text-center text-xs {{ $isActive('admin.kamar.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Kamar
            </a>
            ...
            <a href="{{ route('admin.fasilitas.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-couch w-4 text-center text-xs {{ $isActive('admin.fasilitas.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Fasilitas
            </a>
            ...
            <a href="{{ route('admin.booking.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-calendar-check w-4 text-center text-xs {{ $isActive('admin.booking.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Booking
            ...
            <a href="{{ route('admin.blog.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-newspaper w-4 text-center text-xs {{ $isActive('admin.blog.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Blog
            </a>
            ...
            <a href="{{ route('admin.galeri.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-images w-4 text-center text-xs {{ $isActive('admin.galeri.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Galeri
            </a>
            ...
            <a href="{{ route('admin.review.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-star w-4 text-center text-xs {{ $isActive('admin.review.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Rating & Review
            </a>

            {{-- ── Konfigurasi ── --}}
            <p class="px-3 pt-4 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-500/70">Konfigurasi</p>
            ...
            <a href="{{ route('admin.website-profile.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-globe w-4 text-center text-xs {{ $isActive('admin.website-profile.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Profil Website
            </a>
            ...
            <a href="{{ route('admin.settings.index') }}"
               class="relative flex items-center gap-3 px-3 py-[9px] rounded-lg text-[13px] font-medium transition-all duration-150
                ...
                <i class="fa-solid fa-gear w-4 text-center text-xs {{ $isActive('admin.settings.*') ? 'text-blue-400' : 'text-slate-500' }}"></i>
                Pengaturan
            </a>
        ...
        <div class="px-3 pb-3 pt-2 border-t border-blue-900/40">
            <div class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-white/[0.03] hover:bg-white/[0.06] transition-colors cursor-pointer">
                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center text-white text-xs font-bold">
                    A
                </div>
    ...
    <div class="flex-1 flex flex-col min-h-screen bg-slate-50">
        ...
        {{-- Top Bar --}}
        <header class="sticky top-0 z-10 bg-white border-b border-slate-200 px-6 py-3.5 flex items-center justify-between shadow-sm">

    {{-- BAGIAN KIRI --}}
    <div class="flex items-center gap-3">

        {{-- Avatar --}}
        <div class="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center text-white text-xs font-bold">
        ...
        {{-- Notifikasi --}}
        <button class="relative w-8 h-8 rounded-lg bg-slate-100 hover:bg-slate-200 transition flex items-center justify-center text-slate-500 hover:text-slate-700">

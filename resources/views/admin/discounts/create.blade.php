...
@section('content')
    <div class="max-w-3xl mx-auto py-10">
        ...
        <form method="POST" action="{{ route('admin.kos-discounts.store') }}"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="text-sm font-semibold">Max Diskon</label>
                    <input type="number" name="max_discount" class="input w-full mt-1" placeholder="Contoh: 10000">
